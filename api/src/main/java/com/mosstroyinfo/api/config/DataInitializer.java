...
public class DataInitializer implements CommandLineRunner {
        ...
        if (blueprintRepository.count() == 0) {
            List<Blueprint> blueprints = Arrays.asList(
                    createBlueprint("Проект Д-1", "/media/d1.webp", 10_000_000L,
                            Blueprint.Material.bricks, Blueprint.Seriality.serial, 3, 6, 3, 2, 250),
                    createBlueprint("Проект Д-2", "/media/d2.jpg", 15_000_000L,
                            Blueprint.Material.aeratedConcrete, Blueprint.Seriality.individual, 2, 7, 3, 2, 300),
                    createBlueprint("Проект Д-3", "/media/d3.jpg", 8_000_000L,
                            Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial, 2, 5, 2, 1, 150),
                    createBlueprint("Проект Б-1", "/media/b1.jpg", 5_000_000L,
                            Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 3, 0, 1, 100),
                    createBlueprint("Проект Б-2", "/media/b2.jpg", 6_000_000L,
                            Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 3, 0, 1, 120),
                    createBlueprint("Проект С-1", "/media/s1.jpg", 1_000_000L,
                            Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 1, 0, 0, 40),
                    createBlueprint("Проект С-2", "/media/s2.jpg", 1_100_000L,
                            Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial, 1, 1, 0, 0, 45),
                    createBlueprint("Проект Г-1", "/media/g1.jpg", 1_500_000L,
                            Blueprint.Material.bricks, Blueprint.Seriality.serial, 1, 1, 0, 0, 55),
                    createBlueprint("Проект Г-2", "/media/g2.jpg", 500_000L,
                            Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial, 1, 1, 0, 0, 20)
            );
            ...
            if (adminId != null && userId != null) {
                ...
                if (allBlueprints.size() >= 4) {
                    ...
                    List<Project> projects = Arrays.asList(
                            // Проекты для admin
                            createProject("Коттедж", Project.ProjectStatus.NEW, blueprint101, adminId,
                                    Arrays.asList("https://example.com/doc1.pdf", "https://example.com/doc2.pdf"),
                                    Arrays.asList("https://stream.example.com/project1")),
                            createProject("Баня", Project.ProjectStatus.approval, blueprint201, adminId,
                                    Arrays.asList("https://example.com/doc3.pdf"),
                                    Arrays.asList("https://stream.example.com/project2")),
                            createProject("Гостевой дом", Project.ProjectStatus.pending, blueprint103, adminId,
                                    Arrays.asList("https://example.com/doc4.pdf", "https://example.com/doc5.pdf"),
                                    Arrays.asList()),
                            // Проекты для user1
                            createProject("Сарай", Project.ProjectStatus.completed, blueprint302, userId,
                                    Arrays.asList("https://example.com/doc6.pdf"),
                                    Arrays.asList("https://stream.example.com/project4")),
                            createProject("Гараж", Project.ProjectStatus.completed, blueprint402, userId,
    ...
    private Project createProject(String title, Project.ProjectStatus status, UUID blueprintId, UUID userId,

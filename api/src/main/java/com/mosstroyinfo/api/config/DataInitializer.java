        ...
        public void run(String... args) {
                ...
                if (blueprintRepository.count() == 0) {
                        List<Blueprint> blueprints = Arrays.asList(
                                        createBlueprint("Проект Д-1 бэк", "/media/d1.webp", 10_000_000L,
                                                        Blueprint.Material.bricks, Blueprint.Seriality.serial, 3, 6, 3,
                                                        2, 250),
                                        createBlueprint("Проект Д-2 бэк", "/media/d2.jpg", 15_000_000L,
                                                        Blueprint.Material.aeratedConcrete,
                                                        Blueprint.Seriality.individual, 2, 7, 3, 2, 300),
                                        createBlueprint("Проект Д-3 бэк", "/media/d3.jpg", 8_000_000L,
                                                        Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial,
                                                        2, 5, 2, 1, 150),
                                        createBlueprint("Проект Б-1 бэк", "/media/b1.jpg", 5_000_000L,
                                                        Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 3, 0,
                                                        1, 100),
                                        createBlueprint("Проект Б-2 бэк", "/media/b2.jpg", 6_000_000L,
                                                        Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 3, 0,
                                                        1, 120),
                                        createBlueprint("Проект С-1 бэк", "/media/s1.jpg", 1_000_000L,
                                                        Blueprint.Material.timber, Blueprint.Seriality.serial, 1, 1, 0,
                                                        0, 40),
                                        createBlueprint("Проект С-2 бэк", "/media/s2.jpg", 1_100_000L,
                                                        Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial,
                                                        1, 1, 0, 0, 45),
                                        createBlueprint("Проект Г-1 бэк", "/media/g1.jpg", 1_500_000L,
                                                        Blueprint.Material.bricks, Blueprint.Seriality.serial, 1, 1, 0,
                                                        0, 55),
                                        createBlueprint("Проект Г-2 бэк", "/media/g2.jpg", 500_000L,
                                                        Blueprint.Material.aeratedConcrete, Blueprint.Seriality.serial,
                                                        1, 1, 0, 0, 20));

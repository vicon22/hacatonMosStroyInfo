...
export const Create = memo(function Create() {
  ...
  const [formState, setFormState] = useState<CreateProjectPayload>({
    title: "",
    blueprint_id: searchParams.get("blueprint_id") || "",
  });
      ...
      <Row>
        <Col size={[12, { l: 12 }]}>
          <Breadcrumbs>
            ...
            <Breadcrumbs.Item disabled>{t("projects.create")}</Breadcrumbs.Item>
          </Breadcrumbs>
        </Col>
      </Row>
      ...
      <Row>
        <Col size={[12, { l: 7 }]}>
          <Button
            ...
            disabled={
              mutation.isPending || !formState.blueprint_id || !formState.title
            }

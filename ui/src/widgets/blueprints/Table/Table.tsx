      ...
      <Row>
        <Col size={[12, { l: 12 }]}>
          <Breadcrumbs>
            ...
            <Breadcrumbs.Item disabled>{t("nav.blueprints")}</Breadcrumbs.Item>
          </Breadcrumbs>
        </Col>
      </Row>
        ...
        <UITable
          columns={[
            ...
            },
            {
              ...
              width: 150,
              template(item) {
                return <Link href={`blueprints/${item.id}`}>{item.title}</Link>;
              },
            },
            ...
            { id: "floors", name: t("tables.columns.labels.floors") },
            {
              id: "material",
              width: 100,
              name: t("tables.columns.labels.material"),
              template(item) {
                return <Label>{materialLabels[item.material]}</Label>;
              },
            },

...
import { Breadcrumbs, Button, Card, Col, Container, Divider, Row, Text, TextInput } from "@gravity-ui/uikit";
            ...
            <Row space='10'>
                        ...
                        <div className={st.properties}>
                            <div className={st.property}>
                                ...
                                <Text variant='subheader-1'>
                                    {blueprint.data?.floors}
                                </Text>
                            </div>

                            <div className={st.property}>
                                <Text variant='body-1'>
                                    {t('tables.columns.labels.area')}
                                </Text>
                                <Text variant='subheader-1'>
                                    {blueprint.data?.area}
                                </Text>
                            ...
                            <div className={st.property}>
                                ...
                                <Text variant='subheader-1'>
                                    {blueprint.data?.material}
                                </Text>
                            </div>

                            <div className={st.property}>
                                <Text variant='body-1'>
                                    {t('tables.columns.labels.rooms')}
                                </Text>
                                <Text variant='subheader-1'>
                                    {blueprint.data?.rooms}
                                </Text>
                            </div>
                ...
                <Col size={[12, {l: 3}]}>
                    <Card view='filled' className={st.info} theme='info'>
                        ...
                        <Button pin='circle-circle' size='xl' view='action' width='max'>
